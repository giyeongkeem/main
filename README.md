...
| 4. 이미지 제작 | **디자인·편집** | HTML/CSS 템플릿으로 카드 슬라이드 렌더링 (WYSIWYG 미리보기) |
| 5. 출력 & 패키징 | **내보내기** | 1080px 고해상도 PNG + ZIP 다운로드, 캡션 복사 |
| 6. 수정 기능 | **디자인·편집** | 텍스트·색상·템플릿·순서·카드 추가/삭제를 실시간 편집. 어느 단계든 자유롭게 되돌아가 수정 |
...
- **WYSIWYG 카드** — 미리보기와 내보낸 PNG가 동일한 HTML/CSS에서 나옵니다 (Playwright로 캡처).
